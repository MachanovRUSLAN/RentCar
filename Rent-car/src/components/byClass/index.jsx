...
function ByClass() {
  ...
  return (
    <div className="w-[100%] lg:grid hidden">
      ...
      <div className="buttons w-[70%] m-auto lg:flex hidden justify-between my-4">
        <button
          className="border py-[10px] font-[600] px-[20px] text-[#979797] rounded-[8px]"
          value=""
      ...
      <div className="allsee  m-auto  lg:w-[300px]">
        <button
          onClick={showMore}
          className="w-[231px]  rounded-[10px] text-[18px]  font-[600] p-3 text-[#F36F20]  border border-orange-500"
        >
          Hamisini Goster
        </button>
      </div>
